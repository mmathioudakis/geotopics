#  Source: https://raw.githubusercontent.com/rossant/smopy/master/smopy.py
# Modified to fetch from other sources
...
def get_url(x, y, z):
    ...
    return "http://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png".format(z=z, x=x, y=y)
